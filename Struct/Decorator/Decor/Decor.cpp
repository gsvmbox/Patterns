...
public:
    ...
    string Operation() const override {
        ...
        return "Конкретный декораторA(" + Decorator::Operation() + ")";
     }
};
/**
...
public:
    ...
    string Operation() const override {
        ...
        return "Конкретный декораторB(" + Decorator::Operation() + ")";
     }
};
/**
...
int main() {
    ...
    cout << "Клиент: Получен простой компонент:\n";
    ClientCode(simple);
    cout << "\n\n";
    /**
    ...
    cout << "Клиент: Получен декорированный компонент:\n";
